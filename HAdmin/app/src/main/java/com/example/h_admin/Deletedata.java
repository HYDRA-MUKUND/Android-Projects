...
public class Deletedata extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        if (checks.equals("mydata")) {
            String login_url = "http:/192.168.43.6/delete.php";
            try {
                String ps_nummm=strings[1];
                ...
                String post_datal = URLEncoder.encode("id", "UTF-8") + "=" + URLEncoder.encode(ps_nummm, "UTF-8") ;
